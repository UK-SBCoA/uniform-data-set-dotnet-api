...
namespace UDS.Net.API.Data.Migrations
{
    ...
    [Migration("20260204202716_AddM1Submission3")]
    partial class AddM1Submission3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UDS.Net.API.Entities.A4a", b =>
                {
                    ...
                    b.Property<int?>("NEWADEVENT")
                        .HasColumnType("int");

                    b.Property<int?>("NEWTREAT")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UDS.Net.API.Entities.C2", b =>
                {
                    ...
                    b.Property<bool?>("RESPASST")
                        .HasColumnType("bit");

                    b.Property<bool?>("RESPDISN")
                        .HasColumnType("bit");

                    b.Property<bool?>("RESPDIST")
                        .HasColumnType("bit");

                    b.Property<bool?>("RESPEMOT")
                        .HasColumnType("bit");

                    b.Property<bool?>("RESPFATG")
                        .HasColumnType("bit");

                    b.Property<bool?>("RESPHEAR")
                        .HasColumnType("bit");

                    b.Property<bool?>("RESPINTR")
                        .HasColumnType("bit");

                    b.Property<bool?>("RESPOTH")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("UDS.Net.API.Entities.M1Submission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("MilestoneSubmissionId")
                        .HasColumnOrder(0);
            ...
            modelBuilder.Entity("UDS.Net.API.Entities.M1SubmissionError", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("M1SubmissionErrorId")
                        .HasColumnOrder(0);
                    ...
                    b.HasIndex("M1SubmissionId");

                    b.ToTable("M1SubmissionErrors");
                });
            ...
            modelBuilder.Entity("UDS.Net.API.Entities.M1SubmissionError", b =>
                {
                    b.HasOne("UDS.Net.API.Entities.M1Submission", "M1Submission")
                        .WithMany("M1SubmissionErrors")
                        .HasForeignKey("M1SubmissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("M1Submission");
                });
            ...
            modelBuilder.Entity("UDS.Net.API.Entities.M1", b =>
                {
                    b.Navigation("M1Submissions");
                });

            modelBuilder.Entity("UDS.Net.API.Entities.M1Submission", b =>
                {
                    b.Navigation("M1SubmissionErrors");
                });
